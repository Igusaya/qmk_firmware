...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|                    |------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | Caps |                    |  CAD |   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+------+------.      ,------+------+------+------+------+------+-------------|
   * | Ctrl |  GUI |  ALt |   | EISU |  | Lower| Space|Delete|      | Bksp | Enter| Raise|  | Home |   |PageUp|PageDN|  End |
   * ,-------------------------------------------------------.      ,-------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    JP_MINS,                        JP_EQL , KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_JYEN, \
  ...
  [_LOWER] = LAYOUT(
    ...
    JP_TILD,  KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,   JP_LCBR,                        JP_RCBR, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, JP_COLN, JP_DQT , \
